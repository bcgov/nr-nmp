...
export async function getRaspberryNutrients(
  ...
  try {
    ...
    console.error('Error calculating crop requirement removal for raspberries:', error);
    return nutrientInputs;
  }
}
...
export async function getBlueberryNutrients(
  ...
  try {
    ...
    console.error('Error calculating crop requirement removal for blueberries:', error);
    return nutrientInputs;
  }
}
