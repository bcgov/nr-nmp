...
import { PER_DAY_PER_ANIMAL_UNIT } from '@/constants';
 ...
 * Calculates the solid manure generated by a type of animal in a year, in US tons.
 * @param poundsPerAnimal The coefficient of solid manure per pound per animal per day
 * @param birdsPerFlock The number of birds in a flock
 * @param flocksPerYear The anumber of flocks per year
 * @param daysPerFlock The number of days manure is collected per flock
 */
export function calculatePoultryAnnualSolidManure(
  poundsPerAnimal: number,
 ...
 * @param daysPerFlock The number of days manure is collected per flock
 */
export function calculatePoultryAnnualLiquidManure(
  galsPerAnimal: number,
  birdsPerFlock: number,
  flocksPerYear: number,
  daysPerFlock: number,
