...
\copy temp_fertilizer_types (Id, Name, DryLiquid, Custom, StaticDataVersionId) from 'docker-entrypoint-initdb.d/_FertilizerTypes__20241212.csv' with header delimiter ',' CSV ;
